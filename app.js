...
var incompleteTaskHolder=document.getElementById("ul__incomplete-tasks");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("ul__completed-tasks");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="main__task main__input-text";
    ...
    deleteButtonImg.className = 'list-item__picture';
